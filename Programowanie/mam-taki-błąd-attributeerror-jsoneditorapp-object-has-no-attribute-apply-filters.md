# Mam taki błąd  AttributeError: 'JsonEditorApp' object has no attribute 'apply_fi

**Data:** 13 gru 2025, 00:10:16 CET
...
Mam taki błąd 
AttributeError: 'JsonEditorApp' object has no attribute 'apply_filters'

---

**Gemini:**

Przepraszam za to przeoczenie. Przy przepisywaniu i rozszerzaniu kodu o nowe funkcje pominąłem definicję metody `apply_filters`, chociaż nadal do niej odwoływałem się przy wiązaniu zdarzeń klawiatury (`bind`).

Metoda ta jest konieczna, aby program wiedział, co zrobić, gdy wpisujesz tekst w pola filtra.

Oto **kompletny, naprawiony kod**. Możesz go skopiować w całości i zastąpić nim poprzedni plik.
...
class JsonEditorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Advanced JSON List Editor v2.1")
    ...
    def _setup_styles(self):
        ...
        # Zwiększone odstępy (rowheight=35)
    ...
    def _create_widgets(self):
        ...
        # Tutaj wywoływana jest funkcja apply_filters
    ...
    # --- BRAKUJĄCA METODA ZOSTAŁA DODANA PONIŻEJ ---
    def apply_filters(self, event=None):
        """Wywoływana przy każdym naciśnięciu klawisza w polach filtra."""
        self.refresh_list()
